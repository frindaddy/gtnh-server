...
RUN apk add unzip
ADD https://downloads.gtnewhorizons.com/ServerPacks/GT_New_Horizons_2.7.2_Server_Java_17-21.zip /minecraft
RUN unzip GT_New_Horizons_2.7.2_Server_Java_17-21.zip && rm GT_New_Horizons_2.7.2_Server_Java_17-21.zip

RUN rm /minecraft/eula.txt && echo 'eula=true' > /minecraft/eula.txt
